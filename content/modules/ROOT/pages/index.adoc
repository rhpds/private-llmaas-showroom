...
=== **Module 1:** Activate the Code Assistant and Use AI to Enhance your Coding Skills
Step into the app developer's perspective. Connect to the model endpoint you deployed and then integrate it into a developer facing code assistant to help you develop for your work, bridging infrastructure and app logic.

=== **Module 2:** Leverage the power of Agentic AI tooling
...
For our workshop, we have provisioned an environment on an OpenShift Container Platform cluster for each participant, with Red Hat OpenShift AI deployed.
